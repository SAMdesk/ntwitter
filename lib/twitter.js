...
Twitter.prototype.post = function(url, content, content_type, callback) {
  ...
  this.oauth.post(url + '?' + querystring.stringify({ tweet_mode: 'extended' }),
    this.options.access_token_key,
    this.options.access_token_secret,
...
Twitter.prototype.showStatuses = function(ids, callback) {
  var url = '/statuses/lookup.json';
  var params = {id : ids, include_entities: true };
  this.post(url, params, null, callback);
  return this;
};
Twitter.prototype.getStatuses
  = Twitter.prototype.showStatuses;
...
Twitter.prototype.showUser = function(id, callback) {
  ...
  id.forEach(function(item) {
    if(item.toString().substr(0, 'handle:'.length) === 'handle:')
      names.push(item.toString().substr('handle:'.length));
    else if (+item)
      ids.push(item);
    else
      names.push(item);
...
// list_id
// or
// slug and owner_screen_name
// https://dev.twitter.com/rest/reference/get/lists/show
Twitter.prototype.showList = function(params, callback) {
  var url = '/lists/show.json';
  this.get(url, params, callback);
  return this;
};
...
Twitter.prototype.getListTimeline = function(params, callback) {
  var url = '/lists/statuses.json';
  this.get(url, params, callback);
  return this;
};
...
//calls https://api.twitter.com/1.1/lists/create.json
// params:
// name
// mode (public or private)
// description
Twitter.prototype.createList = function(params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = null;
  }

  var url = "/lists/create.json"; // + querystring.stringify(params);
...
// handles delete by list_id or by owner_screen_name/slug
Twitter.prototype.deleteList = function(params, callback) {
...
// FIXME: Uses deprecated Twitter lists API
Twitter.prototype.getListMembers = function(screen_name, slug, params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = null;
  }

  var url = '/lists/members.json';
  params = utils.merge(params, { owner_screen_name: screen_name, slug: slug, key:'users' });
  this._getUsingCursor(url, params, callback);
  return this;
};

Twitter.prototype.getListMembers2 = function(list_id, params, callback) {
  ...
  var url = '/lists/members.json';
  params = utils.merge(params, { list_id: list_id });
  this.get(url, params, callback);
  return this;
};
...
// screen_name (list of handles)
// max 100 at a time
Twitter.prototype.addListMembers = function(list_id, params, callback) {
    var url = '/lists/members/create_all.json';
    params = utils.merge(params, { list_id: list_id });
    this.post(url, params, callback);
    return this;
};
...
Twitter.prototype.addListMember = function(list_id, params, callback) {
    var url = '/lists/members/create.json';
    params = utils.merge(params, { list_id: list_id });
    this.post(url, params, callback);
    return this;
};
...
// screen_name (list of handles)
// max 100 at a time
Twitter.prototype.deleteListMembers = function(list_id, params, callback) {
    var url = '/lists/members/destroy_all.json';
    params = utils.merge(params, { list_id: list_id });
    this.post(url, params, callback);
    return this;
};
...
Twitter.prototype.getListSubscribers = function(params, callback) {
  var url = '/lists/subscribers.json';
